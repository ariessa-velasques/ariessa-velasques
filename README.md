```diff
@@ Fullstack Developer & Game Designer in the making @@

+ Software Engineering student at UNIPAMPA 🇧🇷
- Powered by rhythm games, cats 🐱 and frogs 🐸
! Building with TypeScript, Python, Lua and Ren'Py
# Exploring Visual Novels, RPGs and interactive worlds
```
---

### 🚀 Featured Project

**No-Code Engine for Visual Novel Creation** — Capstone Project in Software Engineering (UNIPAMPA)
